...
-	Run nameserver: python nameserver.py (Note: In case this command throws error, move to next step because nameserver is already
	running.)
-	Run database server: python databaseserver.py (id of 0 is assigned to it).
-	Run server 1: python server1.py (dicts.py and lock.py should be in same folder as this script file. id of 1 is assigned to it.)
-	Run server 2: python server2.py (id of 2 is assigned to it)
